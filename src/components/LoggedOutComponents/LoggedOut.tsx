...
import { 
  Button,
  Flex, FormControl, FormLabel, Heading, Input, Text, Box, Select, chakra, Image
    ...
    return (
        <Flex direction="column" width="100%" height="100%" bg="#E4DCCF">
            ...
            <Flex minH="50vh" bg="purple.100" direction="row" align="center" p="50px">
                <Flex direction="column" justify="center" align="left" width="50%">
                ...
                <Flex direction="column" justify="center" align="center" width="50%">
                    <Image
                        objectFit='cover'
            ...
            <Flex direction="column" bg="white" p="50px" align="center">
